...
import '../controller/bloc_movie_details/tv_details_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<TvDetailsBloc>()
        ..add(
          GetTvDetailsEvent(id),
        )
        ..add(
          GetTvRecommendationEvent(id),
        ),
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                const SizedBox(width: 16.0),
                                Text(
                                    _showDuration(state.tvDetail!.seasonNamber),
                                    style: Theme.of(context)
                                        .textTheme
                                        .titleMedium),
                              ],
